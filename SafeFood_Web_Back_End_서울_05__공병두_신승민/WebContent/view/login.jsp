...
<body>
	...
	<div class="container">
		...
		<div class="container" style="display: inline-block;" align="center">
			<h1 style="color: navy; font-weight: bold; font-size: x-large;">Login</h1>

			<form action="loginProcess.safefood">
				<div class="form-group">
					<label for="id" style="width: 300px; text-align: left;">E-mail
						ID</label> <input type="text" class="form-control" id="id"
						name="id" style="width: 300px;">
				</div>
				<div class="form-group">
					<label for="pwd" style="width: 300px; text-align: left;">Password</label>
				...
				<button
					style="font-weight: bold; color: white; background-color: navy;"
