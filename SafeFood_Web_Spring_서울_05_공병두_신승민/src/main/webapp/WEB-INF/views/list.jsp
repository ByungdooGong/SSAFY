								...
								<div>
									...
									<c:if test="${not empty id }">
										<form action="eats.safefood?code=${f.code }" method="post"
											style="display: inline-block;">
											<button type="submit" id="add" class="btn btn-default detail">먹기</button>
										</form>
										<form action="pick.safefood?code=${f.code }" method="post"
											style="display: inline-block;">
											<button type="submit" id="pick"
												class="btn btn-default detail">찜하기</button>
										</form>
									</c:if>
								</div>
							</li>
